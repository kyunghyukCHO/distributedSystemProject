...
public class PersistentThread extends Thread {
    ...
    private int clientLogicalClock = 0;
                ...
                if (message.contains(":")) {
                    ...
                    if (pars[0].equals("JOIN")) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                File copyFile = new File("/Users/chokyunghyuk/testtest4/src/Client/ServerFiles/" + fileName);
                    ...
                    try {
                        ...
                        try {
                            fileName = dis.readUTF();
                            receivedFileNames.add(fileName);
                            File copyFile = new File("/Users/chokyunghyuk/testtest4/src/Client/SharedFiles/" + fileName);
                            long fileTransferSize = dis.readLong();
                            bos = new BufferedOutputStream(new FileOutputStream(copyFile, false));
                            int bufSize = 1024;
                            int totalReadCount = (int) fileTransferSize / bufSize;
    ...
    public void setClientLogicalClock(int clientLogicalClock) {
        this.clientLogicalClock = clientLogicalClock;
    }
}
